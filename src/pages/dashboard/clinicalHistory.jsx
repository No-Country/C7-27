...
export default function GetClinicHistories() {
    ...
    const submit = async () => {
        try {
            const url = `${process.env.NEXT_PUBLIC_VERCEL_URL || process.env.NEXT_PUBLIC_API_URL}/api/clinicHistory/getClinicHistory`;
            ...
            if (filteredList) {
                ...
                response.data.history.map((history) => {
                    const filtered = history.details.filter(detail => detail.professionalRef == user.professionalRef)
                    ...
                    <FormControl sx={{ width: '100%' }}>
                        ...
                        >
                            ...
                            {patientList.map((patient) => (
                                <MenuItem key={uuidv4()} value={patient.clinicHistoryRef} sx={{ textTransform: 'capitalize' }}>
                            ...
                            {clinicHistory.map((speciality) => (
                                <Accordion key={uuidv4()}>
                                    <AccordionSummary
                                        ...
                                        id="panel1a-header"
                                    >
                                        <Typography sx={{ textTransform: 'capitalize' }}>{speciality.speciality.toLowerCase()}</Typography>
                                    </AccordionSummary>
